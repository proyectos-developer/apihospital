...
router.post ('/api/doctor', async (req, res) => {
    const {nombres, apellidos, correo, nro_telefono, usuario, fecha_nacimiento, genero, especialidad, descripcion, titulo_grado, direccion, pais, provincia, distrito} = req.body
    try {
        const newDoctor = {nombres, apellidos, correo, nro_telefono, usuario, fecha_nacimiento, genero, especialidad, descripcion, titulo_grado, direccion, pais, provincia, distrito}
...
router.post ('/api/doctor/:usuario', async (req, res) => {
    ...
    const {nombres, apellidos, correo, nro_telefono, fecha_nacimiento, genero, especialidad, descripcion, titulo_grado, direccion, pais, provincia, distrito} = req.body

    try {
        const updateDoctor = {nombres, apellidos, correo, nro_telefono, fecha_nacimiento, genero, especialidad, descripcion, titulo_grado, direccion, pais, provincia, distrito}
